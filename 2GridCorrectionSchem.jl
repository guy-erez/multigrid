...
function MG_2!(n_cells::Array, h::Array, initial_guss::Array, w, f::Array, output::Array, iter_num::Int)
    ...
    # compute output_laplasian <- laplas(output_jacobi) with Diriclet boundry conditions
    ...
    #comute laplasin(error) = residual on coarse grid
...
function test_MG_2()
    ...
    MG_2!(n,h,initial_guss,w,f,output,1000)
